			...
			<div class="container mt-2">
				<div clas="row row-center">
					<div class="col-lg-12">
						...
						<div class="form-group">
                        <textarea class="form-control" rows="5" id="comment" placeholder="ระบุรายละเอียด"></textarea>
                        </div>
                        <div class="form-group">
							<input type="text" class="form-control" placeholder=ผู้แจ้ง>
						</div>
						<div class="form-group">
							<button type="button" class="btn btn-primary btn-block" onclick="repair()">ยืนยัน</button>
						</div>
					</div>
				</div>
			</div>
